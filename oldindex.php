...
<!-- nav -->
 ...
 <div class="container-fluid">
	<div class=" home row "><!-- blocks  row -->
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <h1 class="home_text white"><a name="home"></a>Brendan Jackson</h1>

		<br><br>
		<h3 class="white">
            To continuously learn and grow in a field that is always changing. <br>
            To deliver a product that customers can enjoy & use with ease,<br>
            our company can showcase for future prospects, and that I can be proud of.
        </h3>
...
<div class="container-fluid">
	<div class="about blocks row"><!--row--> 
    ...
    <div><!--row-->    <!-- was container -->
      ...
      <div class="portfolio-content  "><!--was container"-->
            ...
            <div class="row portfolio-links"><!-- -->
                <!-- Portfolio img1-->
                <div class="col-md-4 col-sm-6 portfolio-item"><!-- col-md-4 col-sm-6-->
                ...
                <!-- Portfolio img2 -->
                <div class="col-md-4 col-sm-6 portfolio-item portfolio2"> <!-- col-md-4 col-sm-6 -->
...
<div class="container-fluid">
	<div id="contact" class="blocks row"><!--row-->
